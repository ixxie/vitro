...
- Only the repo dir is mounted via virtiofs (at `/<repo-name>`) — the
  sole writable host-shared path inside the env.
...
**Network:** `vitrobr` bridge on `192.168.83.0/24`, systemd-networkd
